...
/**
 * Kontroler widoku do edycji wezlow forum. Zawiera i koordynuje dzialanie
 * podkontrolerow widokow dla poszczegolnych typow wezlow (zadania, sugestii,
 * etc.). W zaleznosci od typu aktualnie edytowanego wezla wyswietlane sa tylko
 * te widoki, ktore odpowiadaja temu wezlowi.
 * 
...
public class DetailsPaneController implements Initializable {
	...
	public void memPane(MainPaneController mainPaneController) {
		contentController.memPane(mainPaneController);
		suggestionController.memPane(mainPaneController);
		taskController.memPane(mainPaneController);
		surveyController.memPane(mainPaneController);
	}
