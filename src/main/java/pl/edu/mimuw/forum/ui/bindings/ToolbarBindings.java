...
public class ToolbarBindings {
	...
	public ToolbarBindings(Runnable onNew, Runnable onOpen, Runnable onSave, Runnable onUndo, Runnable onRedo,
			Runnable onAddNode, Runnable onDeleteNode, ObservableBooleanValue canCreateNew,
			ObservableBooleanValue canOpen, ObservableBooleanValue canSave, ObservableBooleanValue canUndo,
			ObservableBooleanValue canRedo, ObservableBooleanValue canAddNode, ObservableBooleanValue canDeleteNode) {
		this.onNew = onNew;
		this.onOpen = onOpen;
		this.onSave = onSave;
		this.onUndo = onUndo;
